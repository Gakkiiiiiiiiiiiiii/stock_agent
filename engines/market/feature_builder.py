...
class MarketFeatureBuilder:
    ...
    def build(self, as_of: datetime | None = None, force_refresh: bool = False) -> dict[str, Any]:
        ...
        sectors_payload = self.provider.get_sector_strength()
        ...
        index_return_5d = _pct_to_decimal(snapshot.get("index_return_5d", indices.get("return_5d_pct")))
        index_return_20d = _pct_to_decimal(snapshot.get("index_return_20d", indices.get("return_20d_pct")))
        index_drawdown_20d = _pct_to_decimal(snapshot.get("index_drawdown_20d", indices.get("drawdown_20d_pct")))
        ...
        feature = {
            ...
            "index_volatility_20d": _pct_to_decimal(snapshot.get("index_volatility_20d", indices.get("volatility_20d_pct"))),
            ...
            "quality_score": snapshot.get("quality_score") or _quality_score(snapshot),
