...
GATE_REGISTRY: dict[str, dict] = {
    ...
    "HistoricalData": {"pytest": ["tests/test_market_feature_history.py"]},
    "DataQuality": {"pytest": ["tests/test_market_feature_history.py"]},
    ...
    "SkillEvolution": {"pytest": ["tests/test_skill_contract_linter.py"]},
    "StrategyFactory": {"pytest": ["tests/test_p2_automation.py"]},
    "DecisionReplay": {"pytest": ["tests/test_decision_replay.py"]},
