...
EXPECTED_ROUTES = {
    ...
    ("GET", "/api/v2/audit/decisions/{decision_id}/lineage"),
    ("POST", "/api/v2/analysis/stock"),
    ("POST", "/api/v2/analysis/theme"),
    ("GET", "/api/v1/compatibility/analysis/stock/{symbol}"),
    ("GET", "/health/formal-decision-ready"),
    ("GET", "/health/analysis-ready"),
